...
export const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  "Transporte": ["uber", "99", "gasolina", "combustível", "combustivel", "estacionamento", "pedágio", "pedagio", "ônibus", "onibus", "metrô", "metro", "taxi", "gas", "fuel", "parking", "bus", "subway", "transport", "essence", "carburant", "péage", "peage", "benzin", "tanken", "tankstelle"],
  "Moradia": ["aluguel", "condomínio", "condominio", "iptu", "luz", "água", "agua", "gás", "internet", "energia", "rent", "electricity", "water", "utilities", "loyer", "électricité", "electricite", "eau", "miete", "strom", "wasser"],
  "Saúde": ["farmácia", "farmacia", "médico", "medico", "dentista", "hospital", "remédio", "remedio", "consulta", "pharmacy", "doctor", "dentist", "medicine", "pharmacie", "médecin", "medecin", "apotheke", "arzt", "zahnarzt"],
  ...
  "Lazer": ["cinema", "show", "viagem", "netflix", "spotify", "jogo", "bar", "festa", "parque", "movie", "travel", "game", "party", "park", "concert", "voyage", "film", "fête", "fete", "reise", "kino", "spiel", "party"],
  "Vestuário": ["roupa", "calçado", "calcado", "tênis", "tenis", "camisa", "vestido", "sapato", "clothes", "shoes", "shirt", "dress", "vêtements", "vetements", "chaussures", "kleidung", "schuhe"],
